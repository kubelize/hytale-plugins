...
import com.kubelize.securewarps.commands.CommandArgUtil;
...
public class InventoryDeleteCommand extends AbstractCommand {
  ...
  @Nonnull
  private final RequiredArg<UUID> uuidArg = this.withRequiredArg("uuid", "Player UUID", CommandArgUtil.typed(ArgTypes.PLAYER_UUID));
